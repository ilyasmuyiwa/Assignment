...
class Interceptor extends \Magento\Downloadable\Block\Catalog\Product\Samples implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function hasSamples()
    {
        ...
        if (!$pluginInfo) {
            return parent::hasSamples();
        } else {
            return $this->___callPlugins('hasSamples', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getSamples()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getSamples', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getSampleUrl($sample)
    {
        ...
        if (!$pluginInfo) {
            return parent::getSampleUrl($sample);
        } else {
            return $this->___callPlugins('getSampleUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getSamplesTitle()
    {
        ...
        if (!$pluginInfo) {
            return parent::getSamplesTitle();
        } else {
            return $this->___callPlugins('getSamplesTitle', func_get_args(), $pluginInfo);
        }
    }
