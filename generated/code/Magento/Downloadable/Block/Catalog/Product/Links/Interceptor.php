...
class Interceptor extends \Magento\Downloadable\Block\Catalog\Product\Links implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getLinksPurchasedSeparately()
    {
        ...
        if (!$pluginInfo) {
            return parent::getLinksPurchasedSeparately();
        } else {
            return $this->___callPlugins('getLinksPurchasedSeparately', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getLinkSelectionRequired()
    {
        ...
        if (!$pluginInfo) {
            return parent::getLinkSelectionRequired();
        } else {
            return $this->___callPlugins('getLinkSelectionRequired', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function hasLinks()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('hasLinks', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getLinks()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getLinks', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCurrencyPrice($price)
    {
        ...
        if (!$pluginInfo) {
            return parent::getCurrencyPrice($price);
        } else {
            return $this->___callPlugins('getCurrencyPrice', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getLinkSampleUrl($link)
    {
        ...
        if (!$pluginInfo) {
            return parent::getLinkSampleUrl($link);
        } else {
            return $this->___callPlugins('getLinkSampleUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getLinksTitle()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getLinksTitle', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getIsOpenInNewWindow()
    {
        ...
        if (!$pluginInfo) {
            return parent::getIsOpenInNewWindow();
        } else {
            return $this->___callPlugins('getIsOpenInNewWindow', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getIsLinkChecked($link)
    {
        ...
        if (!$pluginInfo) {
            return parent::getIsLinkChecked($link);
        } else {
            return $this->___callPlugins('getIsLinkChecked', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getLinkCheckedValue($link)
    {
        ...
        if (!$pluginInfo) {
            return parent::getLinkCheckedValue($link);
        } else {
            return $this->___callPlugins('getLinkCheckedValue', func_get_args(), $pluginInfo);
        }
    }
